class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add Rocket (p1)
        this.p1Rocket = new Rocket(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'bird').setOrigin(1, 0);

        // add butterflys (x2)
        this.ship01 = new Spaceship(this, game.config.width + borderUISize*6, borderUISize*4, 'butterfly', 0, 30).setOrigin(0, 0);
        this.ship03 = new Spaceship(this, game.config.width, borderUISize*6 + borderPadding*4, 'butterfly', 0, 10).setOrigin(0,0);

        // bee
        this.ship02 = new NotSpaceship(this, game.config.width + borderUISize*3, borderUISize*5 + borderPadding*2, 'bee', 0, 100).setOrigin(0,0);
    ...
    update() {
        ...
        if(!this.gameOver) {
            ...
            this.ship01.update();               // update butterfly (x3)
            this.ship02.update();
            this.ship03.update();
        }
